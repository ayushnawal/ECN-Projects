...
HD_PWD='C:/Users/Abhishek/Desktop/concentric_circle/concentric_circle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circle.tcl
