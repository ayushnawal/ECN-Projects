...
HD_PWD='C:/Users/Abhishek/Desktop/concentric_circle/concentric_circle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circle.tcl -notrace
