...
HD_PWD='C:/Users/Abhishek/Desktop/DLD Lab/Lab_1_LED/Lab_1_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_main.tcl
