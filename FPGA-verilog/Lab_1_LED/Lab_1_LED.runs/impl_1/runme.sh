...
HD_PWD='C:/Users/Abhishek/Desktop/DLD Lab/Lab_1_LED/Lab_1_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_main.tcl -notrace
