...
HD_PWD='C:/Users/Abhishek/Desktop/DLD Lab/Lab_1_16to1MUX/Lab_1_16to1MUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SixteenToOne.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SixteenToOne.tcl
