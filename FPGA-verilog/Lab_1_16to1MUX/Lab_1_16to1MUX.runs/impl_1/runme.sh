...
HD_PWD='C:/Users/Abhishek/Desktop/DLD Lab/Lab_1_16to1MUX/Lab_1_16to1MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SixteenToOne.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SixteenToOne.tcl -notrace
